...
);riot.tag2('app', '<navbar></navbar> <main-content></main-content>', 'app .container,[data-is="app"] .container{ width: 100% height: 100% }', 'class="container"', function (opts) {});
...
var riot = __webpack_require__(0
//src: src/tags/blog/posts-list.tag
);riot.tag2('posts-list', '<h2 class="c-heading">{title}</h2> <post each="{post in posts}" data="{post}">', '', '', function (opts) {
  this.posts = [{
    title: 'post 1',
...
var riot = __webpack_require__(0
//src: src/tags/main-content.tag
);riot.tag2('main-content', '<main class="o-container o-container--large u-pillar-box--small"> <posts-list></posts-list> </main>', 'main-content,main-content main,[data-is="main-content"] main{ height: 100%; width: 100%; }', '', function (opts) {});
...
var _postsList = __webpack_require__(3);
